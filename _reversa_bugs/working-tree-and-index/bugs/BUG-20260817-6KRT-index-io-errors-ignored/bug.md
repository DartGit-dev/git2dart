...
traceability:
  specs:
    - "_reversa_sdd/working-tree-and-index/requirements.md#functional-requirements"
    - "_reversa_sdd/working-tree-and-index/flows.md#fl-wi-01-stage-paths-and-write-a-tree"
