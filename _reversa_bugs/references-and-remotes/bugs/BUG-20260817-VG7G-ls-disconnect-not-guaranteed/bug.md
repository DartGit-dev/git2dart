...
traceability:
  specs:
    - "_reversa_sdd/references-and-remotes/requirements.md#responsibilities-and-rules"
    - "_reversa_sdd/references-and-remotes/flows.md#fl-rr-03-list-remote-advertisements"
