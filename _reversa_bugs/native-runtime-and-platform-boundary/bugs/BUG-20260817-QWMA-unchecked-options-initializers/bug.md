...
traceability:
  specs:
    ...
    - "_reversa_sdd/native-runtime-and-platform-boundary/tests.md#coverage-matrix"
    - "_reversa_sdd/adrs/004-centralize-native-error-translation.md#decision"
    - "_reversa_sdd/references-and-remotes/tests.md#coverage-matrix"
    - "_reversa_sdd/working-tree-and-index/tests.md#coverage-matrix"
