...
- 🟢 **CONFIRMED** — `lib/src/repository.dart:181-203`, repository/clone bindings, callback extraction, ADR-006, and `reversa/sdd/flowcharts/repository-lifecycle-clone.md`.
...
- 🟢 **CONFIRMED** — `lib/src/repository.dart:393-409`, `test/repository_test.dart:302-324`, `reversa/sdd/state-machines.md`.
...
- 🟢 **CONFIRMED** — `lib/src/repository.dart:584-654`, `test/repository_test.dart:255-337`, `reversa/sdd/flowcharts/repository-lifecycle-status.md`.
